                    ...
                    <div className="h-[520px] w-full flex items-center justify-between">
                        <div className="h-full w-full flex flex-col items-start justify-center">
                            <div className="flex items-end gap-2">
                                ...
                                {/* Make animation to move hand */}
                                <h1 className="text-[40px] font-bold animate-wave">👋🏻</h1>
                            </div>                            
                            <h1 className="text-2xl font-bold">I'm french fullstack developer.</h1>
                        ...
                        <div className="h-full w-full flex items-center justify-center">
                            <div className="flex items-center justify-center">
                                <div className="size-[180px] rounded-full bg-blue-500">
                                </div>
                            </div>
                        </div>
                    </div>
