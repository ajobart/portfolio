...
export default function Home() {
  ...
  return (
    <div
      className={`relative w-full h-fit flex flex-col items-start justify-start ${
        isDarkMode
          ? "dark bg-home-dark text-primary-dark"
          : "bg-home-light text-primary-light"
      }`}
    >
      <Navbar />
          ...
          <div className="h-[calc(100vh-64px)] w-full flex items-center justify-between">
            ...
            <div className="h-full w-full flex flex-col items-start justify-center">
              ...
              <h1 className="text-5xl mt-2 font-bold">
                I'm Alexis Jobart a french fullstack developer.
              </h1>
              <p className="text-m mt-2 font-normal">
                Love keep learning, clean design and create things.
              </p>
              <ul className="flex gap-2 mt-4">
                <li>
                  <a
                    href="https://www.linkedin.com/in/alexis-jobart-9340a516b/"
                    target="_blank"
                    className="btn-primary flex gap-1"
                  >
                    <Image
                      path="/icons/linkedin-logo-light.svg"
                      className="size-4"
                    ></Image>
                    Linkedin
                  </a>
                ...
                <li>
                  <a
                    href="https://github.com/ajobart/"
                    target="_blank"
                    className="btn-primary flex gap-1"
                  >
                    <Image
                      path="/icons/github-logo-light.svg"
                      className="size-4"
                    ></Image>
                    Github
                  </a>
                ...
                <li>
                  <a
                    href="mailto:jobart.pro@gmail.com"
                    target="_blank"
                    className="btn-primary flex gap-1"
                  >
                    <Image
                      path="/icons/email-logo-light.svg"
                      className="size-4"
                    ></Image>
                    Get in touch
                  </a>
            ...
            <div className="h-full w-[350px] flex items-center justify-center">
              <div className="relative flex items-center justify-center h-full w-[350px]">
                <div className="absolute z-[40] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-fit w-full">
                  <Image
                    path="/images/memoji-wink.png"
                    alt="hand"
                    className="size-[350px]"
                  />
                </div>
                <div className=" z-[2] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
              </div>
            </div>
          </div>
          {/* SECTION ABOUT */}
          <div className="h-fit w-full flex flex-col items-center justify-center mb-20 gap-12">
            ...
            <div className="flex gap-12">
              ...
              <div className="relative w-full flex flex-col gap-4">
                {/* Skills section */}
                <div className="flex flex-col gap-8 rounded-xl py-2 px-4 box-border backdrop-blur-md dark:bg-[#363C46]/40 bg-white/10 border border-gray-50/20">
                  {/* Skills header */}
                ...
                {/* Card section */}
                <div className="h-fit w-full rounded-xl py-2 px-4 box-border backdrop-blur-md dark:bg-[#363C46]/40 bg-[#D5EFFF] border border-gray-50/20">
                  <ul className="flex flex-row items-center justify-between">
                    <li className="flex flex-col items-center justify-center gap-1">
                      <p className="font-bold dark:text-portfolio-blue-dark text-portfolio-blue-light text-2xl">
                        3+
                      </p>
              ...
              <div className="w-full flex flex-col items-start justify-start gap-6">
                <p className="text-base font-normal">
                  I grew up in Normandy, where I pursued business studies and
                  obtained a Bachelor's degree. During my studies, I started
                  coding websites in my spare time, which quickly became a
                  passion. After graduating, I decided to follow what I truly
                  love and enrolled in the "Le Wagon" bootcamp in Paris, where I
                  perfected my development skills.
                </p>
                <p className="text-base font-normal">
                  For the past three years, I've been based in Paris and have
                  been making a living as a developer. I currently collaborate
                  with the talented team at the FORKEYS agency, where I continue
                  to grow and evolve in my craft.
                </p>
              </div>
            </div>
          </div>
