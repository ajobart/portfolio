  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'grid-darkmode': "linear-gradient(0deg, rgba(32,32,35,1) 60%, rgba(0,212,255,0) 100%), url('/icons/grid-light.svg')",
        'grid-lightmode': "linear-gradient(0deg, rgba(244,244,245,1) 60%, rgba(0,212,255,0) 100%), url('/icons/grid-dark.svg')",
      },
      colors: {
